  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        {/* soften blobs on small/tablet to avoid crowding */}
      ...
      <div className="mx-auto max-w-screen-xl px-5 py-10 sm:px-6 md:px-8 md:py-14 lg:py-20">
        {/* Responsive grid:
            - 1 column on phones
            - 2 columns on tablets with comfortable ratio
            - looser ratio on desktop */}
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[1.05fr_0.95fr] md:gap-10 lg:grid-cols-[1.2fr_1fr] lg:gap-14 md:items-center">
          ...
          <section className="max-w-2xl md:max-w-xl">
            ...
            <div className="mt-7 md:mt-8">
              <GoogleLoginButton />
              <p className="mt-3 flex items-center gap-2 text-xs text-neutral-300 md:text-[0.8rem]">
          ...
          <aside className="relative order-first md:order-none">
            <div className="card mx-auto max-w-md p-4 sm:p-5 md:max-w-md lg:max-w-lg">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 md:mt-5">
                {[
                  ...
                  <div
                    key={x.s}
                    className="rounded-xl border border-neutral-200/60 p-3 text-sm dark:border-neutral-800"
                  >
                    <div className="flex items-center justify-between">
                      <span className="font-medium">{x.s}</span>
                      <span
                        className={x.c.startsWith("-") ? "text-red-600" : "text-emerald-600"}
                      >
                        {x.c}
                      </span>
                    </div>
            ...
            {/* badge positioned safely on tablets */}
      ...
      {/* footer */}
      <footer className="px-5 pb-8 text-center text-[11px] text-neutral-300 md:text-xs">
